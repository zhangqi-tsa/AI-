...
#
# Usage:
#   run-pipeline.sh --config configs/my-service.yaml
#   run-pipeline.sh --config configs/my-service.yaml --stage review
#   run-pipeline.sh --config configs/my-service.yaml --skip-record
set -uo pipefail
...
FLOW_SCRIPT="${FLOW_SCRIPT:-generated/${SERVICE_NAME}/core-flow.py}"

# Report path
REPORT_DIR="reports/${SERVICE_NAME}"
